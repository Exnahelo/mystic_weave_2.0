...
Canonical structured runtime world data lives here. JSON under `data/world/` is the authoritative machine-facing layer for migrated world content.

Rules:
- use one JSON file per navigable location node
