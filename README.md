...
api/
  ...
  models.py            # Pydantic v2 models (schema/release version 4.8.0)
...
schemas/
  openapi.json         # OpenAPI document format 3.1.0, schema/release version 4.8.0 — upload to GPT builder Actions
scripts/
...
**Current backend/schema version:** 4.8.0
