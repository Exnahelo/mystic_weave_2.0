...
api/
  ...
  models/              # Pydantic v2 models package (schema/release version 5.4.2)
...
schemas/
  openapi.json         # OpenAPI document format 3.1.0, schema/release version 5.4.2 — upload to GPT builder Actions
scripts/
...
**Current backend/schema version:** 5.4.2
