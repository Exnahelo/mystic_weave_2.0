...
**Resolution**
- **7 domains** (Power, Agility, Perception, Endurance, Intellect, Will, Presence) scored 25–80 (starting values typically 25–60 before bonuses)
...
api/
  ...
  models/              # Pydantic v2 models package (schema/release version 5.1.2)
...
schemas/
  openapi.json         # OpenAPI document format 3.1.0, schema/release version 5.1.2 — upload to GPT builder Actions
scripts/
...
**Current backend/schema version:** 5.1.2
