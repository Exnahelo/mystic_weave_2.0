...
Where Thornveil works at scale. Not industrial, not even production-line, but organized enough that craft lineages preserve themselves across generations and output reaches Vaelmere for realm trade in reliable quantity.

## Scene Texture

The Crafthall district is the most visibly "worked" part of Thornveil. Workshop buildings are larger than the residential dwellings of the Hearth — not by realm warehouse standards, but substantial enough to hold a craft lineage's working space, material stores, and apprentice stations. Smoke from careful hearth-work drifts up through canopy vents; the sound of craft is continuous from early morning through evening; raw and finished goods move through at a steady rhythm.
...
- Resinheart resins, sealants, incense.
- Preserved Heartmorel and related culinary fungi.
- Goldcap cider, forest wines, honey mead (though some of these ship from the Common Hearth as well).
- Elven-worked goods from metal, wood, and leather lineages.
- Dyes, pigments, and specialty craft materials.
- Very rare Longbough-material artifacts (when a branch-sign has produced craftable material).

The Trade Envoy Crafthall Liaison — a Council-appointed coordinator working between the Crafthall's senior crafters and Vaelmere's Trade Master — ensures quality standards, timing, and output planning. This is a senior role, typically held by an elf with sustained Crafthall experience and realm-side trade exposure.

## Visitors

Realm visitors reach the Crafthall rarely and with specific sanction. Scholars studying elven craft traditions occasionally spend extended time here with the master whose lineage they are studying. Realm-side crafters of particular distinction are sometimes received at their counterparts' workshops for sustained exchange — these are meaningful events, not tourist visits.

Visitors walking through the Crafthall without business are discouraged without being refused. Workshops are working spaces; visitors without a master's attention drift rather than learn.
