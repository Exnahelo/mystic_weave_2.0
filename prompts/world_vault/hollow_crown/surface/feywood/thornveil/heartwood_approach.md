...
The city's innermost ring. The Heartwood at its center, the Council at its side, the oldest families in residence around both. The register here is quieter and more weighted than anywhere else in Thornveil.

## Scene Texture

The Approach is entered rather than entered-into. Paths from the outer districts converge on it through a gradient of increasingly ancient growth, so a walker notices the transition more by ambient feel than by any threshold. Trees here are older than anywhere else in the city, and the ambient field is closer to its saturated state; sensitive visitors register the shift in the air, the specific quality of light filtering through centuries-old canopy, the reduced sound from the surrounding city.
...
The Council of Elders' primary chambers occupy a grove near the district's heart. Several ancient trees form a natural meeting space that generations of elven craft have enhanced — a council grove in the specific sense, not a built hall. The chambers accommodate the full Council when plenary meetings convene, breakout spaces for subcommittee work, and the small archive of written records the Council maintains (treaties, ledgers, formal correspondence, genealogy anchors; oral tradition handles the rest).
...
The Heartwood's clearing sits at the district's geographic center, enclosed by the approach-walks that lead in toward it from several directions. The Heartwarden on Watch rotates through here continuously; druids coordinating daily observance work from the clearing's margin; the Heartwood itself is visible from the Approach's inner edges through the intervening canopy, and the ambient field's intensity is strongest here.

Approach to the Heartwood is not controlled through barriers. It is controlled through disposition. Sanctioned travelers with reason to be at the Heartwood find the approach accommodating. Unsanctioned approach is rare because those without sanction rarely penetrate the Approach at all.

## Visitors

The Approach receives three kinds of visitors regularly:

- **Council business.** Diplomatic envoys, house representatives, occasional realm-side officials arriving for matters requiring Council attention.
...
The Heartwood itself remains its own node (`heartwood`). The Approach is the district that surrounds it; it is not the Heartwood. Scenes that move from the Approach into the clearing transition to the Heartwood node.
