...
The transition from the Rift's Edge into the Rift proper is not marked. There is no signpost, no boundary stone, no physical threshold. The change happens inside the visitor. The Edge is an uncomfortable zone of ambient wrongness — unsettling but survivable. The Rift itself begins wherever the discomfort stops being ambient and becomes specific, personal, attentive. One moment a visitor is walking ordinary broken ground. The next moment the ground is still broken but the air is reading them, and they know it.

The landscape is warped. The terrain is not ruined in the way a battlefield is ruined; the battlefield trauma is a century old and has weathered into the land. What persists is different. The stone is the wrong color — not obviously, but consistently, enough that a visitor notices without being able to articulate what they are seeing. The grass grows in patterns that do not match wind or water flow. The scattered trees at the Rift's outer radius are stunted and misshapen in ways that suggest sustained stress rather than damage from any single event. Animals do not live here. Birds do not cross.

Light behaves strangely. Shadows are slightly wrong — a shade too deep, or slightly the wrong shape, or cast at angles that do not quite match the sun's position. Clear-sky days at the Rift have a muted quality, as though the sunlight has passed through something before reaching the ground. Cloudy days are worse. Rain, on the rare occasions rain falls here, does not feel like rain.
...
## The Corruption and Its Effects

The Rift's active corruption affects visitors. The effects scale with exposure time, proximity to the pit, and the visitor's preparation.

Short exposure (minutes to an hour, staying at the Rift's outer reaches, not approaching the keep): discomfort, fatigue, irritability, mild sense of being watched. Residents of nearby settlements have experienced this without harm. Recovery is rapid.

Moderate exposure (hours, closer approach, possibly entering the keep's ruins): physical symptoms intensify. Headaches, disorientation, disturbed sleep afterward, intrusive thoughts during and for some time after. Recovery takes days.

Extended exposure (a day or more, including time at or near the pit): serious effects. Persistent dreams, shifts in mood and perception, echoes of combat or ceremony memory that are not the visitor's own. Recovery can take weeks and is not guaranteed to be complete. Some visitors return changed in ways that do not reverse.

Exposure beyond that threshold, or direct prolonged proximity to the pit's mouth, can produce effects that do not recover.

The elite Wardens train in the Rift specifically because surviving it is the essential test of their order. Their training includes physical conditioning, magical grounding, meditation practice, and techniques the realm does not share outside the order. A trained elite Warden can spend days at a time in the Rift and return functional. They are not immune; they are disciplined.

The Vigil — the Platinum Acolytes — represents a different relationship entirely. Their century of attending to the Platinum Warden's resonance and the Rift's adjacent corruption has given them something the Wardens do not have: an attunement to the site that lets them move through it without the standard damage. They are not unaffected — the Rift affects them, and the attending wears on them — but they are not diminished by it in the way other visitors are. The Vigil can spend weeks at the Rift when needed. No one else can.
...
The Rift proper is accessed through the Rift of Discord Edge corridor, which provides the standard approach for monitored traffic. The Edge is patrolled by the Vigil and, during active training cycles, by elite Warden candidates and their instructors. Casual visitors reaching the Edge are typically intercepted and redirected by Vigil patrols; the Vigil does not formally forbid Edge access, but its patrols make clear that ordinary residents should not be there.

Entry into the Rift itself requires:

- **Vigil sanction** — a Vigil member accompanying the visitor or explicit permission from the Vigil leadership at Platinum Oath Monastery, OR
- **Warden training authorization** — candidates on active training rotation, with their instructors, OR
- **Council-authorized investigation** — explicit Council sanction for a specific purpose (historical investigation, wardwork, response to detected irregularities), OR
- **Willingness to accept the consequences** — a visitor who simply walks past the Edge into the Rift proper will not be physically restrained, but the Vigil will not assist them and the Rift's effects will assert themselves without mitigation.

Visitors exiting the Rift are typically observed by Vigil patrols without engagement unless the visitor requests assistance. The Vigil's patrol discipline includes allowing people who have entered the Rift to leave it; the site has claimed enough lives already, and the Vigil does not add to that count through neglect.
...
The Rift of Discord is a HAZARD type, not a settlement. Characters entering this node should be treated as entering a dangerous environment with cumulative exposure effects. The GPT should track approximate time-in-Rift during extended scenes and apply effects proportionally.

Exposure effects are narratively described rather than mechanically specified here. The GPT should adjudicate effects in a way consistent with the canonical tiers:
- Short exposure (up to ~1 hour at outer reaches): discomfort, fatigue, mild psychological effects. Recovers within hours of leaving.
- Moderate exposure (several hours, closer approach): physical symptoms (headache, disorientation), psychological effects (intrusive thoughts, disturbed sleep). Recovers over days.
- Extended exposure (a day or more, near the pit): serious effects, possible permanent changes, recovery takes weeks and may be incomplete.
- Prolonged direct pit exposure: effects that may not recover.

Trained elite Wardens and Vigil members are explicitly exceptions — they can operate in the Rift without standard damage due to their specialized training and attunement respectively. Ordinary characters — including player characters — do not have this immunity unless a specific narrative establishes they have earned it.
...
The Vigil's attunement to the site is canonical per `platinum_oath_monastery.md`. This is NOT an explicitly magical effect — it is a practice, a discipline, a century of attending to the Warden's resonance. The Vigil's relative immunity to Rift effects is a consequence of their practice, not a supernatural gift.

The connection to `rift-of-discord-edge` is two-way. The Edge is the safer perimeter corridor; the Rift is the dangerous interior. Movement between them is continuous in narrative terms.

The connection to `southern-dark-quadrant` is the regional parent. Movement into the broader region (toward the Shadowed Hollows, the Temple's surface indicator, or other dark-quadrant terrain) resolves through the regional node.

`known_npcs` is empty because no NPCs reside at the Rift proper. Vigil patrols are transient; Warden candidates are transient; visitors on cause are transient. The site is not inhabited. Any NPC present during a scene is there for a specific reason and should be handled as a scene-instantiated character, not a persistent anchor.

Threat level 3 is a significant marker. This is the highest threat level in the authored settlement set, reflecting the Rift's active danger. A character entering this node without preparation is entering a genuinely hazardous environment. This threat is NOT primarily violent (there are no monsters waiting to attack) — it is environmental, psychological, and cumulative.

`discovered: true` because the Rift's existence is publicly known. Access to it, however, is not casual — see access notes above. Most characters can describe where the Rift is without having ever visited. Actually reaching the interior is rare.