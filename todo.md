...
- [ ] **Brief 24 — Log management strategy.** Periodic compression, retention, or move admin corrections out of the gameplay log. Addresses log bloat surfaced in the May 2 debrief and gives `/state/{session_id}/annotation` (Brief 16) a more permanent home if the log-append substrate proves cramped. Was previously planned as Brief 23.
