...
- [ ] **Brief 21 — Origin vs phase clarification.** Rules + mechanism for emergent → formal arc conversion when phase shifts trigger institutional uptake. Clarifies AP eligibility and prevents "emergent forever" as a permanent escape hatch. Activates the deferred "Whether the GPT correctly distinguishes formal vs emergent" observation. Was previously planned as Brief 20.
