...
- [ ] **Brief 23 — Registry / catalog unification.** Resolve `data/tags/` ↔ `data/catalog/registries/` parallels, `data/economy/` ↔ `data/catalog/economy/`, etc. Single source per category. Absorbs the existing "Catalog stabilization follow-ups" items. Was previously planned as Brief 22.
